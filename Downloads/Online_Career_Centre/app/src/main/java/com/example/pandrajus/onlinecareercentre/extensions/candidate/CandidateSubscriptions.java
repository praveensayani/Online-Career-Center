...
public class CandidateSubscriptions extends AppCompatActivity  implements AdapterView.OnItemSelectedListener,View.OnClickListener,OnChipClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter_req_skills.setDropDownViewResource(R.layout.spinner_item);
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_profile:
                Toast.makeText(this, "Profile selected", Toast.LENGTH_SHORT)
                        .show();
                Intent profile_intent = new Intent(this, CandidateProfile.class);
                startActivity(profile_intent);
                break;
            // action with ID action_settings was selected
            case R.id.action_joblist:
                Toast.makeText(this, "Joblist selected", Toast.LENGTH_SHORT)
                        .show();
            ...
            case R.id.action_resume:
                Toast.makeText(this, "Resume selected", Toast.LENGTH_SHORT)
                        .show();
                Intent intent = new Intent(this, ViewCandidateCV.class);
                startActivity(intent);
                break;
            /*case R.id.action_shortlist:
                Toast.makeText(this, "ShortList selected", Toast.LENGTH_SHORT)
                        .show();
                break;
