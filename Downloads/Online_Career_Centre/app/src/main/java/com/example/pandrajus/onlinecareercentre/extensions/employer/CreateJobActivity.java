...
public class CreateJobActivity extends AppCompatActivity implements View.OnClickListener,AdapterView.OnItemSelectedListener{
    ...
    String qualification = "",category="",reqSkills="",jobType="",jobEndTime = "12";
    ...
    private void loadSpinners() {
        ...
        // Specify the layout to use when the list of choices appears
        adapter_eq.setDropDownViewResource(R.layout.spinner_item);
        // Apply the adapter to the spinner
    ...
    public void onClick(View v) {
        ...
        if((v.getId()) == R.id.create_job){
            ...
            if(isValid)
            {
                ...
                sfso.putUtfString("createdby", MainActivity.userClass.getEmail());
